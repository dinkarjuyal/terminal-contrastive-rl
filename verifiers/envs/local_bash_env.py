    ...
    async def bash(self, command: str) -> str:
        ...
        try:
            proc = await asyncio.create_subprocess_shell(
                ...
                start_new_session=True,  # own process group so children die with kill
            )
            try:
            ...
            # Truncate long outputs to prevent context length errors.
            # 500 chars is enough for numerical answers and short listings.
            if len(combined) > 500:
